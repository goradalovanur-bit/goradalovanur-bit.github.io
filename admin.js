...
(function () {
  ...
  var TYPE_LABEL = { problem: 'Problem', story: 'Essay', code: 'Code', youtube: 'YouTube', pdf: 'PDF' };

  /* Pre-defined "Fields of Mathematics" — mirrors app.js so tag chips and
     the item table render with the same Title Case / acronym formatting. */
  var FIELD_TAGS = {
    'algebra': 'Algebra',
  ...
  var state = {
    ...
    raw: { problems: [], stories: [], code_animations: [], youtube: [], pdf: [], meta: {} },
    dataSha: null,
    editingId: null,
    editingType: null,
    tags: [],
